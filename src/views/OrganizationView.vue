<template>
  ...
  <div v-else>
    <div id="program-committee">
			<h2>Program Committee</h2><hr>
      <ul id="committee-list">
        <li v-for="committee in pc2025" :id="committee['No']">
          <strong>{{ committee.Name }}</strong> (<span class="committee-belong">{{ committee.Affiliation }}</span>) 
        </li>
      </ul>
		</div>
  </div>
...
import program_committee_2025 from "@/assets/info/program_committee_2025.json"
