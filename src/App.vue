    ...
    <div id="introduction" v-bind:class="{'home-nav' : this.$data.page ==='Home'}">
      <div class="big-title-2024" 
        ...
        v-bind:style="{backgroundPosition: '0 ' + offsetY + 'px'}">
          ...
          <div class="workshop-time" v-bind:class="{'hide-description' : this.$data.page !=='Home'}">
            October 1 (8:00 AM - 12:30 PM), 2026 • Room Auditorium Cassin, STRASBOURG CONVENTION CENTER, FRANCE
          </div>
        </div>
  </div>
  </div>
...
@media screen and (min-width: 1280px) {
  ...
  .big-title-2024 {
    background-image: url('./assets/intro-2026.jpg');
    background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('./assets/intro-2026.jpg');
    background-attachment: fixed;
    background-size: cover;
    width: 100%;
    height: 70vh;
